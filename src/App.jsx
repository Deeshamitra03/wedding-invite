...
<AnimatePresence>
  ...
  onClick={() => {
  window.weddingMusic = new Audio("/music/wedding-song.mp3");
  window.weddingMusic.loop = true;
          ...
          <main>
            ...
            <Section id="story" eyebrow="Our Story" title="12 Years of Love">
              <div className="timeline">
                {[['Long Before','Two little hearts, unknown of the journey ahead.','childhood_illustration.png'],['12 Years Ago','Our story began with friendship, laughter & countless dreams.','young.png'],['The Journey','Through ups & downs, we grew together, hand in hand.','memories.png'],['Countless Memories','From little moments to big milestones, we made memories.','couple_pic.png'],['Today','12 years of choosing each other, every single day.','today.png']].map(([title,text,img],i) => (
